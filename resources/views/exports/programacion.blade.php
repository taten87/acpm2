    ...
    <table>
        ...
        <tr>
            <td colspan="8" align="center"
                style="font-size: 14pt; font-weight: bold; background-color: #047857; color: #ffffff; height: 35px; vertical-align: middle;">
        ...
        <thead>
            <tr>
                <th
                    style="font-weight: bold; background-color: #047857; color: #ffffff; text-align: center; border: 1px solid #000000; height: 25px;">
                    Ficha</th>
                <th
                    style="font-weight: bold; background-color: #047857; color: #ffffff; text-align: center; border: 1px solid #000000;">
                    Programa</th>
                <th
                    style="font-weight: bold; background-color: #047857; color: #ffffff; text-align: center; border: 1px solid #000000;">
                    Actividad de Proyecto</th>
                <th
                    style="font-weight: bold; background-color: #047857; color: #ffffff; text-align: center; border: 1px solid #000000;">
                    Competencia</th>
                <th
        ...
        <tbody>
            @foreach ($programaciones as $index => $p)
                <tr>
                    <td align="center"
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->numFicha }}</td>
                    <td
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->programa?->nombre ?? $p->codPrograma }}</td>
                    <td
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->actividad_aprendizaje }}</td>
                    <td
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->competencia?->nombre ?? $p->idCompetencia }}</td>
                    <td
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->resultadoaprendizaje?->nombre ?? $p->idResultadoAprendizaje }}</td>
                    <td align="right"
                        style="border: 1px solid #CCCCCC; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F9FAFB' }};">
                        {{ $p->horas }} Hrs</td>
                    <td align="center"
        ...
        <tfoot>
            <tr>
                <td colspan="5" align="right"
                    style="font-weight: bold; background-color: #D1FAE5; border: 1px solid #047857;">TOTAL HORAS MES:
                </td>
                <td align="right" style="font-weight: bold; background-color: #D1FAE5; border: 1px solid #047857;">
                    {{ $programaciones->sum('horas') }} Hrs</td>
